...
const std::map<position, double> SCORE_SHEET_1{
    // Score rules for SCORE_SHEET_1
    // 10 points to corners
    // -5 points to tiles surrounding corners
    // 5 points to edges
    // 3 points to inner edges
    // else, 1 point
    {position(0,0), 10},        //corner
    {position(0,1), -5},
    {position(0,2), 5},
    {position(0,3), 5},
    {position(0,4), 5},
...
const std::map<position, double> SCORESHEETS[2] = {
    SCORE_SHEET_0,
    SCORE_SHEET_1
};
